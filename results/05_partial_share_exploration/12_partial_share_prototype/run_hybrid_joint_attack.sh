...
#SBATCH --output=results/05_partial_share_exploration/12_partial_share_prototype/results/12_hybridjoint_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python results/05_partial_share_exploration/12_partial_share_prototype/hybrid_joint_attack_test.py --seed 123 --num_samples 50 --chunk 20 --split_layer 5
