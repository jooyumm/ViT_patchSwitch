"""
probes/results/05_partial_share_exploration/13_ln_recalibration/viz.py — [탐색적, 롤백 가능] 이 실험은 .npz를 저장하지
...
사용법:
  python probes/results/05_partial_share_exploration/13_ln_recalibration/viz.py
"""
import os
import matplotlib
matplotlib.use('Agg')
