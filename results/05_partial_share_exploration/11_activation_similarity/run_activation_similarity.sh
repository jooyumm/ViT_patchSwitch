...
#SBATCH --output=results/05_partial_share_exploration/11_activation_similarity/results/11_actsim_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python results/05_partial_share_exploration/11_activation_similarity/activation_similarity.py --num_samples 200 --seed 42 --layers 6 9
