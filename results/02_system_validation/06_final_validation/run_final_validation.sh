...
#SBATCH --output=results/02_system_validation/06_final_validation/results/06_finalval_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python results/02_system_validation/06_final_validation/vitguard_final_validation.py --seed 42 --num_samples 200
