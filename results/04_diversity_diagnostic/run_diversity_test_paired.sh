...
#SBATCH --output=results/04_diversity_diagnostic/08_diversity_diagnostic/results/08_diversity_paired_run_%j.txt
...
python results/04_diversity_diagnostic/08_diversity_diagnostic/vitguard_diversity_test.py --seed 123 --num_samples 50 --chunk 20
