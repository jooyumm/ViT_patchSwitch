"""
probes/results/01_detection_localization/02_localization/viz.py — [탐색적, 롤백 가능] 02_localization_P16.npz를
읽어서 그림만 다시 그린다 (GPU/재실험 불필요). 원자료는 vitguard_localization.py가 만든 것.

사용법:
  python probes/results/01_detection_localization/02_localization/viz.py
"""
import os
import numpy as np
import matplotlib
