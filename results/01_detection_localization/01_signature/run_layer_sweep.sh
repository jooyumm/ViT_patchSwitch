...
#SBATCH --output=results/01_detection_localization/01_signature/results/01_layersweep_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python results/01_detection_localization/01_signature/vitguard_layer_sweep.py --patch_size 16 --num_samples 30 --seed 42
