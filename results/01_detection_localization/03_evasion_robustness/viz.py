"""
probes/results/01_detection_localization/03_evasion_robustness/viz.py — [탐색적, 롤백 가능] 03_evasion_test_P16.npz +
03_range_evasion_P16.npz를 읽어서 회피 시도 3종 비교 그림을 다시 그린다 (GPU/재실험 불필요).

사용법:
  python probes/results/01_detection_localization/03_evasion_robustness/viz.py
"""
import os
import numpy as np
import matplotlib
