"""
probes/results/03_adaptive_attack/07_joint_attack/viz.py — [탐색적, 롤백 가능] 07_joint_attack_test_n50.npz를
읽어서 그림만 다시 그린다 (GPU/재실험 불필요).

사용법:
  python probes/results/03_adaptive_attack/07_joint_attack/viz.py
"""
import os
import numpy as np
import matplotlib
