"""
probes/vitguard_localization.py — [탐색적 검증, 롤백 가능] top-K attention 토큰이 실제
PatchFool 공격 위치와 얼마나 겹치는지 (localization recall/precision).

배경
----
vitguard_layer_sweep.py에서 "공격당한 이미지인지 아닌지" 탐지는 L=12 raw attention으로
...
사용법:
  python probes/vitguard_localization.py --patch_size 16 --num_samples 30 --seed 42
"""
import argparse
import os
import sys
