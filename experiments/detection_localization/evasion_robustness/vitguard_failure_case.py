"""
probes/vitguard_failure_case.py — [탐색적 검증, 롤백 가능] localization 실패 샘플(cheby>1) 진단.

vitguard_localization.py(n=30, P=16, attn_layer_idx=4)에서 top-1 attention이 실제 공격 토큰과
...
사용법:
  python probes/vitguard_failure_case.py --patch_size 16 --num_samples 30 --seed 42
"""
import argparse
import os
import sys
