"""
probes/vitguard_layeridx_generalization.py — [탐색적 검증, 롤백 가능] PatchFool의 토큰 선택
...
사용법:
  python probes/vitguard_layeridx_generalization.py --patch_size 16 --num_samples 30 --seed 42
"""
import argparse
import os
import sys
