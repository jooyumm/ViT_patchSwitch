"""
probes/vitguard_signature.py — [탐색적 검증, 롤백 가능] LaVAN vs PatchFool의 attention rollout
...
사용법:
  python probes/vitguard_signature.py --patch_size 16 --num_samples 30 --seed 42
"""
import argparse
import os
import sys
