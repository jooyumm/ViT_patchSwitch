...
#SBATCH --output=defense/13_ln_recalibration/results/13_lnrecal_run_%j.txt

cd /home/jooyumm/ViT_robust/PatchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/13_ln_recalibration/hybrid_ln_recalibration.py --calib_samples 100 --calib_seed 555 --eval_samples 50 --eval_seed 123 --split_layer 5
