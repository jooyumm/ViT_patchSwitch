...
#SBATCH --output=results/01_detection_localization/03_evasion_robustness/03_evasion_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/01_detection_localization/03_evasion_robustness/vitguard_evasion_test.py --patch_size 16 --num_samples 30 --seed 42
