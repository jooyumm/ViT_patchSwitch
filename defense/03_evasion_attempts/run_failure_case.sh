...
#SBATCH --output=defense/03_evasion_attempts/results/03_failcase_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/03_evasion_attempts/vitguard_failure_case.py --patch_size 16 --num_samples 30 --seed 42
