...
#SBATCH --output=defense/02_localization/results/02_localization_run_%j.txt

cd /home/jooyumm/ViT_robust/PatchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/02_localization/vitguard_localization.py --patch_size 16 --num_samples 30 --seed 42
