...
#SBATCH --output=defense/04_layeridx_generalization/results/nohup_layeridx_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/04_layeridx_generalization/vitguard_layeridx_generalization.py --patch_size 16 --num_samples 30 --seed 42
