...
#SBATCH --output=results/03_adaptive_attack/07_joint_attack/07_jointattack_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/03_adaptive_attack/07_joint_attack/vitguard_joint_attack_test.py --seed 123 --num_samples 50 --chunk 20
