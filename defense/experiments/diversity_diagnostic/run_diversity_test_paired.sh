...
#SBATCH --output=results/experiments/diversity_diagnostic/08_diversity_paired_run_%j.txt
...
python defense/experiments/diversity_diagnostic/vitguard_diversity_test.py --seed 123 --num_samples 50 --chunk 20
