...
#SBATCH --output=results/06_local_token_subdivision/17_local_swap_joint_attack/17_local_swap_joint_attack_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/06_local_token_subdivision/17_local_swap_joint_attack/local_swap_joint_attack_test.py \
