...
#SBATCH --output=results/06_local_token_subdivision/18_local_swap_adaptive_evasion_full/18_local_swap_adaptive_evasion_full_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/06_local_token_subdivision/18_local_swap_adaptive_evasion_full/local_swap_adaptive_evasion_full_test.py \
