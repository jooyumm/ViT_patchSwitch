...
#SBATCH --output=defense/08_diversity_diagnostic/results/08_diversity_paired_run_%j.txt
...
python defense/08_diversity_diagnostic/vitguard_diversity_test.py --seed 123 --num_samples 50 --chunk 20
