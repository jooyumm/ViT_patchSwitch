"""
probes/results/04_diversity_diagnostic/08_diversity_diagnostic/viz.py — [탐색적, 롤백 가능] 08_diversity_test_n50_seed123.npz를
...
사용법:
  python probes/results/04_diversity_diagnostic/08_diversity_diagnostic/viz.py
"""
import os
import numpy as np
import matplotlib
