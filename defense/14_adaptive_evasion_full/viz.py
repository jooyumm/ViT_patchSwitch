"""
probes/defense/14_adaptive_evasion_full/viz.py — [탐색적, 롤백 가능] 14_adaptive_evasion_full_n50_seed123.npz를
...
등으로 이렇게 참조하던 관례를 그대로 따름). 원본 재확인:
  probes/defense/07_joint_attack/results/07_joint_attack_test_n50.npz

사용법:
  python probes/defense/14_adaptive_evasion_full/viz.py
"""
import os
import numpy as np
import matplotlib
