...
#SBATCH --output=defense/14_adaptive_evasion_full/results/14_evasivejoint_run_%j.txt

cd /home/jooyumm/ViT_robust/ViT_patchSwitch
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

python defense/14_adaptive_evasion_full/vitguard_adaptive_evasion_full_test.py --seed 123 --num_samples 50 --chunk 20 --iters 250
