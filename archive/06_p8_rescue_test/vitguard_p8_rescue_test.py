...
def main():
    ...
    # [재구성 주의] 01_layer_sweep_P16_raw.npz는 PatchSwitch/defense/01_detection_feasibility/results/에
    # 있음(vitguard_layer_sweep.py 산출물) -- 이 스크립트(vitguard_p8_rescue_test.py)는
    # PatchSwitch/archive/06_p8_rescue_test/에 있지만 원래 01_detection_feasibility의 산출물을
